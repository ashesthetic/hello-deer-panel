...
Route::get('/fuel-prices', [\App\Http\Controllers\Api\FuelPriceController::class, 'index'])->middleware(['auth:sanctum']);
Route::post('/fuel-prices', [\App\Http\Controllers\Api\FuelPriceController::class, 'store'])->middleware(['auth:sanctum']);
Route::get('/fuel-prices/{fuelPrice}', [\App\Http\Controllers\Api\FuelPriceController::class, 'show'])->middleware(['auth:sanctum']);
...
// Work Hours routes
Route::get('/staff/my-hours', [\App\Http\Controllers\Api\WorkHourController::class, 'myHours'])->middleware('auth:sanctum');
...
Route::get('/staff/vendor-invoices/vendors', [\App\Http\Controllers\Api\VendorInvoiceController::class, 'getVendorsForStaff'])->middleware(['auth:sanctum']);
...
// Staff-specific Fuel Volume routes (Limited access - Add and Edit)
...
Route::put('/staff/fuel-volumes/{fuelVolume}', [\App\Http\Controllers\Api\FuelVolumeController::class, 'updateForStaff'])->middleware(['auth:sanctum']);

// Staff-specific Fuel Price routes (Add only - no edit/delete)
